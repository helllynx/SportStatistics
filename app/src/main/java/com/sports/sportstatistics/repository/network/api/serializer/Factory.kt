package com.sports.sportstatistics.repository.network.api.serializer
...
fun StringFormat.asConverterFactory(contentType: MediaType): Converter.Factory =
    Factory(contentType, Serializer.FromString(this))
...
fun BinaryFormat.asConverterFactory(contentType: MediaType): Converter.Factory =
    Factory(contentType, Serializer.FromBytes(this))
